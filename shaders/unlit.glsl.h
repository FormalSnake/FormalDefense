...
/*
    ...
    Cmdline:
        sokol-shdc -i shaders/unlit.glsl -o shaders/unlit.glsl.h -l metal_macos -f sokol

    Overview:
    =========
    Shader program: 'unlit':
        Get shader desc: unlit_shader_desc(sg_query_backend());
        Vertex Shader: vs_unlit
        Fragment Shader: fs_unlit
        Attributes:
            ATTR_unlit_position => 0
            ATTR_unlit_color0 => 1
    Bindings:
        Uniform block 'vs_unlit_params':
            C struct: vs_unlit_params_t
            Bind slot: UB_vs_unlit_params => 0
*/
...
#endif
#endif
#define ATTR_unlit_position (0)
#define ATTR_unlit_color0 (1)
#define UB_vs_unlit_params (0)
#pragma pack(push,1)
SOKOL_SHDC_ALIGN(16) typedef struct vs_unlit_params_t {
    HMM_Mat4 mvp;
} vs_unlit_params_t;
#pragma pack(pop)
/*
    ...
    vertex main0_out main0(main0_in in [[stage_in]], constant vs_unlit_params& _24 [[buffer(0)]])
    {
        main0_out out = {};
        out.frag_color = in.color0;
        out.gl_Position = _24.mvp * float4(in.position.xyz, 1.0);
        return out;
    }

*/
static const uint8_t vs_unlit_source_metal_macos[548] = {
    0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,0x20,0x3c,0x6d,0x65,0x74,0x61,0x6c,0x5f,
    0x73,0x74,0x64,0x6c,0x69,0x62,0x3e,0x0a,0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,
    0x20,0x3c,0x73,0x69,0x6d,0x64,0x2f,0x73,0x69,0x6d,0x64,0x2e,0x68,0x3e,0x0a,0x0a,
    0x75,0x73,0x69,0x6e,0x67,0x20,0x6e,0x61,0x6d,0x65,0x73,0x70,0x61,0x63,0x65,0x20,
    0x6d,0x65,0x74,0x61,0x6c,0x3b,0x0a,0x0a,0x73,0x74,0x72,0x75,0x63,0x74,0x20,0x76,
    0x73,0x5f,0x75,0x6e,0x6c,0x69,0x74,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,0x0a,0x7b,
    ...
    0x61,0x6e,0x74,0x20,0x76,0x73,0x5f,0x75,0x6e,0x6c,0x69,0x74,0x5f,0x70,0x61,0x72,
    ...
    0x69,0x74,0x69,0x6f,0x6e,0x20,0x3d,0x20,0x5f,0x32,0x34,0x2e,0x6d,0x76,0x70,0x20,
...
*/
static const uint8_t fs_unlit_source_metal_macos[323] = {
    0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,0x20,0x3c,0x6d,0x65,0x74,0x61,0x6c,0x5f,
    0x73,0x74,0x64,0x6c,0x69,0x62,0x3e,0x0a,0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,
    0x20,0x3c,0x73,0x69,0x6d,0x64,0x2f,0x73,0x69,0x6d,0x64,0x2e,0x68,0x3e,0x0a,0x0a,
    0x75,0x73,0x69,0x6e,0x67,0x20,0x6e,0x61,0x6d,0x65,0x73,0x70,0x61,0x63,0x65,0x20,
    ...
    0x69,0x6e,0x2e,0x66,0x72,0x61,0x67,0x5f,0x63,0x6f,0x6c,0x6f,0x72,0x3b,0x0a,0x20,
    0x20,0x20,0x20,0x72,0x65,0x74,0x75,0x72,0x6e,0x20,0x6f,0x75,0x74,0x3b,0x0a,0x7d,
    0x0a,0x0a,0x00,
};
static inline const sg_shader_desc* unlit_shader_desc(sg_backend backend) {
    if (backend == SG_BACKEND_METAL_MACOS) {
        static sg_shader_desc desc;
        static bool valid;
        if (!valid) {
            valid = true;
            desc.vertex_func.source = (const char*)vs_unlit_source_metal_macos;
            desc.vertex_func.entry = "main0";
            desc.fragment_func.source = (const char*)fs_unlit_source_metal_macos;
